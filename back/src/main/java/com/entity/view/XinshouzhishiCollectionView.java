...
public class XinshouzhishiCollectionView extends XinshouzhishiCollectionEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 类型的值
		*/
		private String xinshouzhishiCollectionValue;
	...
	public XinshouzhishiCollectionView() {

	}

	public XinshouzhishiCollectionView(XinshouzhishiCollectionEntity xinshouzhishiCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, xinshouzhishiCollectionEntity);
			...
			* 获取： 类型的值
			*/
			public String getXinshouzhishiCollectionValue() {
				return xinshouzhishiCollectionValue;
			}
			/**
			* 设置： 类型的值
			*/
			public void setXinshouzhishiCollectionValue(String xinshouzhishiCollectionValue) {
				this.xinshouzhishiCollectionValue = xinshouzhishiCollectionValue;
			}
