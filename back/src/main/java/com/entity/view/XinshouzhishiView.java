...
public class XinshouzhishiView extends XinshouzhishiEntity implements Serializable {
	...
	public XinshouzhishiView() {

	}

	public XinshouzhishiView(XinshouzhishiEntity xinshouzhishiEntity) {
		try {
			BeanUtils.copyProperties(this, xinshouzhishiEntity);
