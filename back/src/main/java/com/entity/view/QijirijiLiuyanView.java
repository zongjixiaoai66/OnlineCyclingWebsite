...
public class QijirijiLiuyanView extends QijirijiLiuyanEntity implements Serializable {
	...
	public QijirijiLiuyanView() {

	}

	public QijirijiLiuyanView(QijirijiLiuyanEntity qijirijiLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, qijirijiLiuyanEntity);
