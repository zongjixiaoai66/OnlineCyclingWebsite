...
var centerMenu = [
    ...
    ,{
        name: '路线攻略收藏',
        url: '../luxianCollection/list.html'
    }
    ,{
        name: '骑记分享收藏',
        url: '../qijirijiCollection/list.html'
    }
    ,{
        name: '新手知识收藏',
        url: '../xinshouzhishiCollection/list.html'
    }
...
var indexNav = [
    ...
    {
        name: '骑记分享',
        url: './pages/qijiriji/list.html'
    },
    {
        name: '新手知识',
        url: './pages/xinshouzhishi/list.html'
    },

]

var adminurl =  "http://localhost:8080/zaixianqixingwangzhan/admin/dist/index.html#/login";
